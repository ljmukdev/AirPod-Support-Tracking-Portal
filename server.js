    ...
    try {
        ...
        for (const checkIn of checkInsWithIssues) {
            ...
            tasks.push({
                ...
                description: `Follow up with seller about ${purchase.generation || 'AirPods'} issue (Order: ${purchase.order_number || 'N/A'})`,
            ...
            tasks.push({
                ...
                description: `Ready to open "Item not as described" case for ${purchase.generation || 'AirPods'} (Order: ${purchase.order_number || 'N/A'})`,
                ...
                if (hasChaseBeenSent) {
                    ...
                    if (isFollowUpDue) {
                        ...
                        tasks.push({
                            ...
                            description: `Follow-up #${chaseCount + 1} for ${purchase.generation || 'AirPods'} - ${daysSinceLastChase} day${daysSinceLastChase !== 1 ? 's' : ''} since last chase (Order: ${purchase.order_number || 'N/A'})`,
                            due_date: followUpDue,
                    ...
                    tasks.push({
                        ...
                        description: `${purchase.generation || 'AirPods'} delivery overdue by ${daysOverdue} day${daysOverdue !== 1 ? 's' : ''} (Order: ${purchase.order_number || 'N/A'})`,
