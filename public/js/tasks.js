            ...
            <div class="task-meta" style="margin-top: 16px;">
                ...
                ${task.order_number ? `
                    <div class="task-meta-row">
                        ...
                        <strong>Order:</strong> <a href="https://www.ebay.co.uk/sh/ord/?filter=status:ALL_ORDERS&search=${encodeURIComponent(task.order_number)}" target="_blank" class="order-link" title="View order on eBay">${escapeHtml(task.order_number)}</a>
                    </div>
                ` : ''}
            </div>
