            ...
            <div class="task-meta" style="margin-top: 16px;">
                ...
                ${task.order_number ? `
                    <div class="task-meta-row">
                        ...
                        <strong>Order:</strong> <a href="https://www.ebay.co.uk/mye/myebay/purchase?page=1&q=${encodeURIComponent(task.order_number)}&mp=purchase-search-module-v2&type=v2&pg=purchase" target="_blank" class="order-link" title="View order on eBay">${escapeHtml(task.order_number)}</a>
                    </div>
                ` : ''}
            </div>
